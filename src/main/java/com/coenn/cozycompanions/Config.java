...
/**
 * Basic configuration class for Cozy Companions.
 * Demonstrates how to use Forge's config API. This class is optional but
 * helps keep configuration logic organized.
 */
